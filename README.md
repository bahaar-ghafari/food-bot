...
- `/feedback` (or the "💬 Feedback" button) — asks you to type a message, then forwards it straight to the superadmin's chat (with your chat ID/username attached) and confirms it was sent. This includes the superadmin's own test submissions, so the round-trip is always visible.
